...
const EditBibleForm = ({ }) => {
    ...
    const [bibleData, setBibleData] = useState({
        ...
        laterAnnotations: '', references: '', microfilmDigitalCopy: '', publishedEdition: '', bibliography: '', contents: '',
        locationCountry: '', locationCity: '', locationDetails: '',
    })
        ...
        <div className='form'>
            <Form onSubmit={handleSubmit}>
                <Container>
                    <Row>
                        <Col>
                            ...
                            <Form.Group className="mb-3" controlId="language">
                                ...
                                <Form.Control as="select" value={bibleData.language} onChange={handleInputChange} name="language">
                            ...
                            <Form.Group className="mb-3" controlId="format">
                                ...
                                <Form.Control as="select" value={bibleData.format} onChange={handleInputChange} name="format">
                        ...
                        <Col>
                            <Form.Group className="mb-3" controlId="century">
                                ...
                                <Form.Control as="select" value={bibleData.century} onChange={handleInputChange} name="century">
                        ...
                        <Col>
                            <Form.Group className="mb-3" controlId="scriptGeoculturalArea">
                                ...
                                <Form.Control as="select" value={bibleData.scriptGeoculturalArea} onChange={handleInputChange} name="scriptGeoculturalArea">
                    ...
                    <hr />
                    <div>
                        <Button variant="outline-secondary" as={Link} to={`/bibles`}> Return to all bibles</Button>
                    </div>

                    {user._id === bibleData.owner && <>
                        <Link to="/mycolaborations">
                            <Button className="Buttons" variant="outline-secondary" >Return to my colaborations</Button>
                        </Link>
                    </>}
                </Container>
            </Form>
